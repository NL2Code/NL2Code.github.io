...
author: coder
date: 2019-04-19 00:00:00 +0800
categories: [EMNLP]
tags: [methods]
math: true
image:
  path: /assets/imgs/example-concode.png
  width: 800
  height: 500
  alt: Examples of idioms learned from CONCODE.
---

## 🌸Method

- 📙Title: [Learning Programmatic Idioms for Scalable Semantic Parsing](https://arxiv.org/pdf/1904.09086.pdf)
- 📚Publisher/Date: `EMNLP/2019`
- 🏠Author Affiliation: Univ. of Washington; UC Berkeley; Facebook AI Research
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 🗂️Downstream Benchmark
  ...
  + ATIS-SQL[^atissql]
- 💕Contribution
  + We introduce a simple iterative method to extract idioms from a dataset of programs by repeatedly collapsing the most frequent depth-2 subtrees of syntax parse trees. 
  + We evaluate our approach on two semantic parsing tasks that map NL into 1) general-purpose source code, and 2) executable SQL queries, respectively.
...
[^atissql]: [https://aclanthology.org/P17-1089.pdf](https://aclanthology.org/P17-1089.pdf)
