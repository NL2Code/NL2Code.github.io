...
math: true
image:
  path: /assets/imgs/SO-CG.png
  width: 800
  height: 500
  alt: Overview of our approach paper.
---

## 🌸Method

- 📙Title: [Evaluating How Fine-tuning on Bimodal Data Effects Code Generation](https://arxiv.org/pdf/2211.07842.pdf)
- 📚Publisher/Date: `Arxiv/2022`
- 🏠Author Affiliation: New York University
- 🔗URL: [https://github.com/gabeorlanski/bimodal-code-generation](https://github.com/gabeorlanski/bimodal-code-generation)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- ✈️Relevant Model
  ...
  + GPT-Neo[^gptneo]
- 💕Contribution
  + Does fine-tuning a pretrained decoder language model on unstructured bimodal Stack Overflow data improve its text-to-code generation performance?
  + How does fine-tuning on this data impact the model's ability to generate valid code?
