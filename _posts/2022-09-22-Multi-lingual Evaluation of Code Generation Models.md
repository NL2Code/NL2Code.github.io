...
- Benchmark Name: `MBXP`[^mbxp]
- 📚Publisher/Date: `OpenReview/2022`
- 🏠Author Affiliation: `Under review`
- 🔗URL: `Under review`
- Sub-benchmark
  * MBPP[^mbpp]
...
[^mbxp]: [https://openreview.net/pdf?id=Bo7eeXm6An8](https://openreview.net/pdf?id=Bo7eeXm6An8)
