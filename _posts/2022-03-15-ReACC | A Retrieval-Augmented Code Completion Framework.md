...
math: true
image:
  path: /assets/imgs/ReACC.png
  width: 800
  height: 500
  alt: An illustration of ReACC framework.
---

## 🌸Method

- 📙Title: [ReACC A Retrieval-Augmented Code Completion Framework](https://arxiv.org/pdf/2203.07722.pdf)
- 📚Publisher/Date: `ACL/2022`
- 🏠Author Affiliation: Microsoft Research Asia; Seoul National University; Sun Yat-sen University; Microsoft Devdiv
- 🔗URL: [https://github.com/microsoft/ReACC](https://github.com/microsoft/ReACC)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- ✈️Relevant Model
  ...
  + GraphCodeBERT
- 💕Contribution
  + We propose a retrieval-augmented method to assist the code auto-completion task.
