...
math: true
image:
  path: /assets/imgs/Chain of Thought Prompting Elicits Reasoning in Large Language Models.png
  width: 800
  height: 500
  alt: Chain-of-thought prompting enables large language models to tackle complex arithmetic, commonsense, and symbolic reasoning tasks. Chain-of-thought reasoning processes are highlighted.
---
...
- 📙Title: [Chain of Thought Prompting Elicits Reasoning in Large Language Models](https://arxiv.org/pdf/2201.11903.pdf)
- 📚Publisher/Date: `NeurIPS/2022`
- 🏠Author Affiliation: Google Research, Brain Team
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
