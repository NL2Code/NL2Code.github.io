...
- 📙Title: [Energy-Based Models for Code Generation under Compilability Constraints](https://arxiv.org/pdf/2106.04985.pdf)
- 📚Publisher/Date: `ACL/2021`
- 🏠Author Affiliation: University of Sussex; Naver Labs Europe
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- ✈️Relevant Model
  + GPT-2
- 💕Contribution
  + In this work, we formulate compilable code generation as a constraint satisfaction problem. We show that this formulation leads to a unique distribution represented by an Energy-Based Model (EBM).
  + In our experiments, we show that our approach significantly improves compilability rates without sacrificing diversity or complexity of the generated examples.
...
[^py150]: [Probabilistic model for code with decision trees](https://pavol-bielik.github.io/data/papers/oopsla16-dt.pdf)
