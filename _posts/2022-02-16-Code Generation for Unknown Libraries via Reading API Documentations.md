...
math: true
image:
  path: /assets/imgs/APIDOC.png
  width: 400
  height: 400
  alt: Our framework for code generation via exploiting API documentations.
---

## 🌸Method

- 📙Title: [Code Generation for Unknown Libraries via Reading API Documentations](https://arxiv.org/pdf/2202.07806.pdf)
...
- 🗂️Downstream Benchmark
  + Adapted CoNaLa[^conala]
- ✈️Relevant Model
  + CopyNet
  + RoBERTa
- 💕Contribution
  + We construct a dataset to evaluate code generation for unknown libraries by extending an existing dataset;
  + We propose a framework of code generation with reading API documents to adapt to unknown formal representations and libraries without additional training.
