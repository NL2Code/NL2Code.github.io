...
math: true
image:
  path: /assets/imgs/Synchromesh.png
  width: 800
  height: 500
  alt: Overview of the Synchromesh framework.
---

## 🌸Method

- 📙Title: [Synchromesh Reliable Code Generation from Pre-trained Language Models](https://arxiv.org/pdf/2201.11227.pdf)
- 📚Publisher/Date: `Arxiv/2022`
- 🏠Author Affiliation: Stanford University; X, the moonshot factory; Microsoft Research
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 🗂️Downstream Benchmark
  + Spider (for SQL)[^spider]
  + NLV Corpus (for Vega-Lite)[^nlvcorpus]
  + SMCalFlow's dataset[^smcalflow]
- ✈️Relevant Model
  + GPT-3[^gpt3]
  + Codex[^codex]
- 💕Contribution
  + We propose Target Similarity Tuning for selecting few-shot examples based on the similarity of the programs they describe, improving relevance and downstream performance.
  + We introduce completion engines as an abstraction that can implement rich classes of semantic program constraints, as we demonstrate in SQL, Vega-Lite and SMCalFlow.
  + We introduce a general, constraint-observing decoding algorithm, which aligns programming language constraints with the language model’s token vocabulary.
  + We evaluate our method in three natural language-to-code tasks. CSD and TST both show strong complementary gains in output validity and prediction accuracy across domains.
...
[^nlvcorpus]: [https://arxiv.org/pdf/2110.00680.pdf](https://arxiv.org/pdf/2110.00680.pdf)
[^smcalflow]: [https://direct.mit.edu/tacl/article-pdf/doi/10.1162/tacl_a_00333/1923892/tacl_a_00333.pdf](https://direct.mit.edu/tacl/article-pdf/doi/10.1162/tacl_a_00333/1923892/tacl_a_00333.pdf)
