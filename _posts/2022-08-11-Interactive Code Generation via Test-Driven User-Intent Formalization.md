...
math: true
image:
  path: /assets/imgs/TDUIF.png
  width: 800
  height: 500
  alt: Workflow for test-driven user-intent formalization (TDUIF).
---

## 🌸Method

- 📙Title: [Interactive Code Generation via Test-Driven User-Intent Formalization](https://arxiv.org/pdf/2208.05950.pdf)
- 📚Publisher/Date: `Arxiv/2022`
- 🏠Author Affiliation: Microsoft Research; University of Pennsylvania; University of California
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
