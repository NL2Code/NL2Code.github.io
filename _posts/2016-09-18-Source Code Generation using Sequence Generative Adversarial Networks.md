---
title: Source Code Generation using Sequence Generative Adversarial Networks
author: coder
date: 2016-09-18 00:00:00 +0800
categories: [AAAI]
tags: [methods]
---
...
- 📙Title: [Source Code Generation using Sequence Generative Adversarial Networks](https://github.com/keon/CodeGAN)
- 📚Publisher/Date: `AAAI/2016`
- 🏠Author Affiliation: Shanghai Jiao Tong University; University College London
- 🔗URL: [https://github.com/keon/CodeGAN](https://github.com/keon/CodeGAN)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 🤖Programming Language (PL)
  ...
  + 🚀Platform&Tool
    ...
    * [ ] Other Platform
- 💕Contribution
  + We implement Generative Adversarial Networks (GAN) on source code generation task.
