...
- 📙Title: [Natural Language to Code Translation with Execution](https://arxiv.org/pdf/2204.11454.pdf)
- 📚Publisher/Date: `Arxiv/2022`
- 🏠Author Affiliation: Facebook AI Research; TTI-Chicago; Carnegie Mellon
- 🔗URL: `None`
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- ✈️Relevant Model
  + Codex[^codex]
- 💕Contribution
  + In this work, we introduce execution result–based minimum Bayes risk decoding (MBR-exec) for program selection and show that it improves the few-shot performance of pretrained code models on natural-language-tocode tasks.
