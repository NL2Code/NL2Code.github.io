...
math: true
image:
  path: /assets/imgs/LEAPS.png
  width: 800
  height: 500
  alt: The illustrate of LEASPS.
---

## 🌸Method

- 📙Title: [Learning to Synthesize Programs as Interpretable and Generalizable Policies](https://proceedings.neurips.cc/paper/2021/file/d37124c4c79f357cb02c655671a432fa-Paper.pdf)
- 📚Publisher/Date: `NeurIPS/2021`
- 🏠Author Affiliation: University of Southern California
- 🔗URL: [https://clvrai.github.io/leaps](https://clvrai.github.io/leaps)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 🗂️Downstream Benchmark
  + Karel domain[^karel] with the programming language DSL (Domain-Specific Language)
- 💕Contribution
  + We present a framework that instead learns to synthesize a program, which details the procedure to solve a task in a flexible and expressive manner, solely from reward signals.
...
[^karel]: [https://dl.acm.org/doi/abs/10.5555/527633](https://dl.acm.org/doi/abs/10.5555/527633)
