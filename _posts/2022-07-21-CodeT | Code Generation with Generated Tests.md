...
math: true
image:
  path: /assets/imgs/CodeT-1.png
  width: 800
  height: 500
  alt: The illustration of CodeT. Both the code solutions and the test cases are generated by the pre-trained language model. The best code solution is then selected by a dual execution agreement.
---
