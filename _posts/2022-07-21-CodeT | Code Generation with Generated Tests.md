...
- 📙Title: [CodeT Code Generation with Generated Tests](https://arxiv.org/pdf/2207.10397.pdf)
- 📚Publisher/Date: `Arxiv/2022`
- 🏠Author Affiliation: `Microsoft Corporation`
- 🔗URL: [https://github.com/microsoft/CodeT](https://github.com/microsoft/CodeT)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
![Window shadow](/assets/imgs/CodeT-1.png){: .shadow width="1548" height="864" .w-75 }
_The illustration of CodeT. Both the code solutions and the test cases are generated by the pre-trained language model. The best code solution is then selected by a dual execution agreement._
