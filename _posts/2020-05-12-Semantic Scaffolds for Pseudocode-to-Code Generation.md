...
math: true
image:
  path: /assets/imgs/scaffolds.png
  width: 800
  height: 500
  alt: Pseudocode is translated to code for each line and combined to form a valid program.
---

## 🌸Method

- 📙Title: [Semantic Scaffolds for Pseudocode-to-Code Generation](https://arxiv.org/pdf/2005.05927.pdf)
- 📚Publisher/Date: `ACL/2020`
- 🏠Author Affiliation: University of California
- 🔗URL: [https://github.com/ruiqi-zhong/SemanticScaffold](https://github.com/ruiqi-zhong/SemanticScaffold)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 🗂️Downstream Benchmark
  + spoc[^spoc]
- 💕Contribution
  + We propose the use of semantic scaffolds to add semantic constraints to models for longform language-to-code generation tasks.
...
[^spoc]: [https://nl2code.github.io/posts/SPoC-Search-based-Pseudocode-to-Code](https://nl2code.github.io/posts/SPoC-Search-based-Pseudocode-to-Code)
