...
| Looking for a Handsome Carpenter! Debiasing GPT-3 Job Advertisements | Our goal is to generate job ads that are (1) unbiased, i.e., do not encourage or discourage application from one gender; and (2) realistic, i.e., of a quality comparable to human-generated ads. | University of Oxford | NAACL/2022 |
|  |  |  | 	|
|  |  |  | 	|
|  |  |  | 	|
|  |  |  | 	|
