...
- 📙Title: [A Grammar-Based Structural CNN Decoder for Code Generation](https://lili-mou.github.io/paper/2019-AAAI-code_gen.pdf)
- 📚Publisher/Date: `AAAI/2019`
- 🏠Author Affiliation: Peking University; AdeptMind Research
- 🔗URL: [https://github.com/zysszy/GrammarCNN](https://github.com/zysszy/GrammarCNN)
- 🌐Neural Network (NN)
  + ⚒️Architecture
    * [ ] Feedforward NN (FNN)
...
- 💕Contribution
  ...
  + Experimental results show that our CNN-based code generator outperforms previous RNN approaches to a large extent.
